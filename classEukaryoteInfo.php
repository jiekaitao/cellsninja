...
<body>
  ...
  <details open>
    ...
    <details>
    <summary>Golgi apparatus</summary>
    <div class="faq__content">
      <p>The golgi apparatus is exclusive to eukaryotic cells. The golgi consist of stacks of flat membranous sacs that modify, store, and route products of the endoplasmic reticulum (proteins) and synthesize products such as non cellulose carbohydrates.</p>
    </div>
  </details>
  ...
  <details>
    <summary>Lysosomes</summary>
    <div class="faq__content">
      <p>Lysosomes are only available to eukaryotic cells, as they are single membrane bound sacs.  The lysosome is often considered the “recycler” of the cell, as they decompose cellular waste such as macromolecules, into their monomers to be used by other organelles.  An example of this is the breaking down of glycogen into glucose.</p>
    </div>
  </details>
  ...
  <details>
    <summary>Chloroplast</summary>
    <div class="faq__content">
      <p>The chloroplast is available to the eukaryotic class only, specifically plant cells.  The chloroplast converts light energy into relatively stable chemical energy via the photosynthetic process, similar to the mitochondria.  Within the chloroplast, there is chlorophyll which is responsible for absorbing light and channels it to be converted, as well as giving plants their color.</p>
    </div>
  </details>
  ...
  <details>
    <summary>Mitochondrion</summary>
    <div class="faq__content">
      <p>The mitochondrion is available to the eukaryotic class only, specifically animal cells, responsible for synthesizing adenosine triphosphate (ATP) energy.  The membrane is composed of a phospholipid bilayer that is embedded with proteins, the innermost membrane is what contains the mitochondrial matrix which is where the Krebs cycle takes place.  </p>
    </div>
  </details>
  ...
  <details>
    <summary>Nucleus</summary>
    <div class="faq__content">
      <p>Only available for the eukaryotic cell class, the nucleus is protected by a two lipid bilayer known as the nuclear envelope scattered with pores to allow for vital materials through.  The nucleus acts as the control center for the cell, controlling all functions of the cell, such as metabolism, growth, and also houses all genetic material.  The nucleus also contains a nucleolus, which synthesizes rRNA and ribosomes.</p>
    </div>
  </details>

  <details>
    <summary>Cell Wall</summary>
    <div class="faq__content">
      <p>Provides extra protection to most prokaryotic and specific eukaryotic cells. This is an upgrade to the Cell membrane, as it attaches itself to the outside of the membrane.</p>
    </div>
  </details>
